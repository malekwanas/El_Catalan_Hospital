...
namespace El_Catalan_Hospital.API.Controllers
{
    ...
    public class AccountController : BaseController
    {
        ...
        //---------------------------------------------- patient register ---------------------------------------------//
        [HttpPost("Register")]
        public async Task<ActionResult> RegisterAsync(RegisterDto model , int? receptionistId)
        {
            try
            {
                ...
                var result = await _authService.RegisterPatientAsync(model, receptionistId);
