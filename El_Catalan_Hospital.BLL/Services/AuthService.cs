...
namespace El_Catalan_Hospital.BLL.Services
{
    public class AuthService : IAuthService
    {
        ...
        public async Task<Response> RegisterPatientAsync(RegisterDto model)
        {
            try
            {
                if (model == null)
                ...
                var patientDto = new PatientRegisterDto { AppUserId = user.Id, ReceptionistID = null };
                ...
                var claims = new List<Claim>
       {
           ...
           new Claim("UserName", user.UserName)
                ...
                var patient = _patientRepo.GetPatientByUserId(user.Id);
                ...
                foreach (var role in userRoles)
                {
                    ...
                    if (role == "patient")
                    {
                        ...
                        claims.Add(new Claim("Id", patient.Id.ToString()));
                    }
                    else if (role == "admin")
                    {
